package org.ruben.java.process;
...
@SupportedAnnotationTypes("org.ruben.java.annotation.BuilderProperty") //podemos usar varias anotaciones "org.ruben.java.annotation.*"
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@AutoService(Processor.class) //libreria com.google.auto.service:auto-service
public class BuilderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv)  { //ejecutamos process cuando compilamos las clases que contengan la anotacion BuilderProperty
        ...
        return true; //devuelve true cuando ha termiando de procesar todas las anotaciones y false para continuar
    }       
