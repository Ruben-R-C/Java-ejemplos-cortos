package org.ruben.java.bash.salidaColores;




public class ImprimirEnColor
{
    ...
    public static void main(String aargs[])
    {
        ...
        System.out.println(ANSI_RED + "Texto de color azul sobre fondo verde");
        ...
        System.out.println("Como no lo he resetado sigue igual.");
        System.out.println(ANSI_RESET+"¡Reseteo ahora!" );
